...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_routine'])) {
    ...
    $routineData = $routine; // Update the routine data after saving
}
?>
                ...
                <?php foreach ($class_times as $time): ?>
                    <tr>
                        ...
                        <?php foreach ($days as $day): ?>
                            <td>
                                <?php 
                                $cellId = "{$selected_class}_{$day}_{$time}";
                                $savedSubject = isset($routineData[$day][$time]) ? $routineData[$day][$time] : '';
                                ?>
                                ...
                                <span id="label_<?= $cellId ?>" class="subject-label"><?= $savedSubject ?></span>
